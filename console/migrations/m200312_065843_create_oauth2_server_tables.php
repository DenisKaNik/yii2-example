...
/**
 * Class m200312_065843_create_oauth2_server_tables
 */
class m200312_065843_create_oauth2_server_tables extends Migration
{
    use MigrationTrait;
    ...
    public function up()
    {
        ...
        try {
            ...
            $this->batchInsert('{{%oauth_clients}}', ['client_id', 'client_secret', 'redirect_uri', 'grant_types'], [
                ['testclient', 'testpass', 'http://yii2-example.loc/', 'client_credentials authorization_code password implicit'],
            ]);
